...
class UserResponse(BaseModel):
    ...
    data_updated_at: Optional[str] = Field(
        None,
        description="Timestamp of when the data for this resource was last updated."
    )
    data: UserData = Field(..., description="The nested object containing the user's specific data.")
